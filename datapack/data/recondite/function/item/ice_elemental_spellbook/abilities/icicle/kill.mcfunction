...
execute if entity @s[tag=recondite.icicle.thornring] if entity @e[distance=..1.8,type=!marker,type=!item,type=!item_display,tag=!recondite.icicle.user] as @e[distance=..1.8,type=!marker,type=!item,type=!item_display,tag=!recondite.icicle.user] run damage @s 5 freeze
