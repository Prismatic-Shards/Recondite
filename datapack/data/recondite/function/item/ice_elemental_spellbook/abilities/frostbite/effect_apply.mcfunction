...
execute if predicate recondite:thorn_ring_offhand rotated as @s positioned ^ ^ ^1.5 run damage @n[nbt={HurtTime:10s},distance=..6.5,tag=!recondite.frostbite.user] 8 freeze
