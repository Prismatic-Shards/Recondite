...
execute unless predicate recondite:is_sneaking as @s[scores={recondite.iceshock.cooldown=400..,recondite.ice_spell.value=3}] run function recondite:item/ice_elemental_spellbook/ice_shock/ice_shock
execute if predicate recondite:thorn_ring_offhand unless predicate recondite:is_sneaking as @s[scores={recondite.snowgrave.cooldown=600..,recondite.ice_spell.value=4}] run function recondite:item/ice_elemental_spellbook/abilities/snowgrave/snowgrave
execute if predicate recondite:thorn_ring_offhand unless predicate recondite:is_sneaking run damage @s 2 generic
