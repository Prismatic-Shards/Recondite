...
# in translations/recondite 
for file in os.listdir("translations/recondite"):
  print(file)
  with open(f"translations/recondite/{file}", "r", encoding="utf-8") as f:
    data = json.load(f)
...
for lang in translations:
  ...
  with open(f"translations/recondite/{lang}", "w", encoding="utf-8") as f:
    json.dump(final, f, ensure_ascii=False, indent=2)

  with open(f"resource_pack/assets/recondite/lang/{lang}", "w+", encoding="utf-8") as f:
    json.dump(final, f, ensure_ascii=False, indent=2)
